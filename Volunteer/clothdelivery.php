...
<div class="content-box container pickup_food_box">
	<div class="table-responsive">
		<table class="table">
			...
			<?php
  $sql1="SELECT * FROM cloth ORDER BY id DESC";
  ...
  {$i=1;
   while($data=$res1->fetch_assoc()){
   	...
   	<tr>
		...
		<td>
		 <a class="btn btn-primary nav_btn" href="clothpick.php?pickid=<?php echo $data['id']; ?>" class="text-light" name="pickdonation" value="<?php echo $data['dstatus']; ?>" method="POST"><?php echo $data['dstatus']; ?></a>
