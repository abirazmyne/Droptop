...
if((isset($_POST['submit'])))
{
  ...
  $sql="UPDATE food SET dlocation='$dlocation', dname='$dname', email='$email', phone='$phone', daddress='$daddress', quantity='$quantity', dstatus='Picked', picked_by='$picked_by' WHERE id=$id";
